...
/**
 * This command momentarily raises/retracts the bridge mechanism. It terminates after one
 * cycle but does not stop the motor. This can be used with Button::whileHeld()
 * to lower the bridge while a button is held down.
 * @author Sam Crow
 */
public class BridgePushMomentaryRetract extends CommandBase {

	Timer timer = new Timer();

	public BridgePushMomentaryRetract() {
