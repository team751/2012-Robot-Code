...
/**
 * Feeds balls into the roller for a very very long time
 * @author Programmer
 */
public class ReallyLongFire extends CommandBase {

    Timer timer;

    /** The number of seconds to feed one ball */
    public static final double kFireTime = 3;

    /**
     * Constructor
     */
    public ReallyLongFire() {
